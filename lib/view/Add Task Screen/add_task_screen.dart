...
import 'package:event_app/view/CreateTeam/create_team_screen.dart';
            ...
            children: [
              Row(
                children: [
                  ...
                  const Text('Add Task',style: TextStyle(fontSize: 22,fontWeight: FontWeight.w500))
                ],
              ),

              SizedBox(height: height * 0.04),
              const Text('Task Name',style: TextStyle(color: Colors.grey,fontSize: 17)),
              ...
              const Text('Date',style: TextStyle(color: Colors.grey,fontSize: 17)),
              SizedBox(height:  height *0.02),
              TextFormField(
                decoration: InputDecoration(
                  contentPadding:   EdgeInsets.only(top: height * 0.05,left: 15,right: 10),
              ...
              SizedBox(height:  height *0.03),
               Row(
                children: [
                  const Text('Start Time',style: TextStyle(color: Colors.grey,fontSize: 17)),
                  SizedBox(width: width * 0.28),
                  const Text('End Time',style: TextStyle(color: Colors.grey,fontSize: 17)),
              ...
              SizedBox(height: height * 0.03),
              const Text('Board',style: TextStyle(color: Colors.grey,fontSize: 17)),
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: const Center(child: Text('Urgent',style: TextStyle(fontSize: 19,fontWeight: FontWeight.w500,color: Colors.grey),)),
                    ),
                    Container(
                      margin: const EdgeInsets.only(right: 10),
                      height: height *0.06,
                      ...
                      child: const Center(child: Text('Running',style: TextStyle(fontSize: 19,fontWeight: FontWeight.w500,color: Colors.grey),)),
                    ),  Container(
                      margin: const EdgeInsets.only(right: 10),
                      height: height *0.06,
                      width:  width *0.28,
                      ...
                      child: const Center(child: Text('ongoing',style: TextStyle(fontSize: 19,fontWeight: FontWeight.w500,color: Colors.grey),)),
                    ),
                  ],
                ),
              ),
              ...
              Center(
                child: SizedBox(
                    ...
                    child: ElevatedButton(onPressed: (){
                      Navigator.push(context, MaterialPageRoute(builder: (_) => const CrateTeamScreen()));
