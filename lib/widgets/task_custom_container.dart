  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          /// time
          Text(startTime,style: TextStyle(color: theme.primaryColor,fontWeight: FontWeight.w600,fontSize: 17)),
          Row(
                    ...
                    children: [
                      ...
                      const Row(
                        ...
                        children: [
                          ...
                          Text('10am - 11am',style: TextStyle(color: Colors.white))
